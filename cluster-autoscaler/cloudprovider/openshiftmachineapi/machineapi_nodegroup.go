...
import (
	...
	machinev1beta1 "sigs.k8s.io/cluster-api/pkg/client/clientset_generated/clientset/typed/cluster/v1alpha1"
)
...
// TemplateNodeInfo returns a schedulernodeinfo.NodeInfo structure of
// an empty (as if just started) node. This will be used in scale-up
